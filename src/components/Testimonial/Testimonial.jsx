...
const TESTIMONIALS = [
  {
    ...
    name: 'María González',
    role: 'Chef y propietaria · Coquinaria',
  ...
  },
  {
    id: 2,
    quote:
      '“Antes tenía que cargar factura por factura a mano. Ahora le saco una foto y la aplicación reconoce los productos, precios e IVA. Revisamos que esté todo bien y listo. Nos ahorra muchísimo tiempo, especialmente cuando recibimos varias facturas en el día.”',
    caption: 'Herramienta esencial para cualquier restaurante.',
    name: 'Laura Ramírez',
    role: 'Propietaria · Merlina',
  ...
  },
  {
    id: 3,
    quote:
      '“Lo que más nos gusta es que no solo lee la factura, sino que actualiza los precios, el proveedor y el movimiento de stock. Antes era fácil olvidarse de cargar algo. Ahora tenemos todo registrado y podemos controlar mejor nuestros costos.”',
    caption: 'Resultados reales desde el primer mes.',
    name: 'Ian',
    role: 'Encargado · Café del Patio',
